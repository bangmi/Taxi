package com.martin.taxi.common.http.api;

/**
 * 项目名：myTaxi
 * 包名：italker.yijia.net.mytaxi.common.http.api
 * 文件名：API
 * 创建者：周成东
 * 创建时间:2017/10/13 11:01
 * 描述：ToDo
 */

public class API {
    public static final String TEST_GET = "/get?uuid=${uuid}";
    ...
    public static class Config {
        private static final String TEST_DOMAIN = "http://cloud.bmob.cn";//测试环境域名
        private static final String RElEASE_DOMAIN = "http://cloud.bmob.cn";//发布环境域名
